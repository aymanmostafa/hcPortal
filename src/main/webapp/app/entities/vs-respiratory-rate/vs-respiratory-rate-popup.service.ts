...
export class VsRespiratoryRatePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.vsRespiratoryRateModalRef(component, new VsRespiratoryRate());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    vsRespiratoryRateModalRef(component: Component, vsRespiratoryRate: VsRespiratoryRate): NgbModalRef {
        const modalRef = this.modalService.open(component, { size: 'lg', backdrop: 'static'});
        modalRef.componentInstance.vsRespiratoryRate = vsRespiratoryRate;
