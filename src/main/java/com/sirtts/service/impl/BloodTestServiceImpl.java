...
public class BloodTestServiceImpl implements BloodTestService {
     ...
     */
    @Override
    public Page<BloodTestDTO> findAllByUserid(String[] userids, String startDate, String endDate, Pageable pageable) {
        log.debug("Request to get all BloodTests");
        if(userids == null) {
        ...
        return bloodTestRepository.findAllByUseridInAndAndMeasurmentdateBetweenOrderByMeasurmentdateDesc(userids, start, end, pageable)
            .map(bloodTestMapper::toDto);
    }
